class Tag < Sequel::Model
  ...
  def self.map_POS(pos)
    tags = {"verb" => "vb", "noun" => "nn", "adverb" => "rb", "adjective" => "jj", "qualifier" => "ql" }
  ...
  def self.map_POS_to_conjugation(tag)
    conjugations = {"vb" => [:present, :habitual, :first], "vbn" => [:past, :perfective], "vbg" => [:present, :progressive], "vbz" => [:present, :habitual]}
  end
